    ...
    sidebar: { // 根据页面路径显示不同的侧边栏
      ...
      '/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Apache', link: 'https://hujinya.com/vuepress/#/software-installation/apache/' },
            { text: 'Git', link: 'https://hujinya.com/vuepress/#/software-installation/git/' }
          ]
        },
        {
          text: '多级菜单示例',
